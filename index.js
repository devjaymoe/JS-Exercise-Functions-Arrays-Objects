...
//var sam = makePersonObject(2343, "Sam", "email@email.com")
//console.log(sam);
...
//console.log(getName({id:1, name:"leia", email:"email@email.com"}))
/**
...
function makeSmartPerson(nameInput) {
  return {name: nameInput, sum: function(num1, num2){return num1 + num2},speak: function(){return `Hello, my name is ${this.name}`}}
}
...
//console.log(getOlderCars(inventory, 2013));
/**
